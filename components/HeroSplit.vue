      ...
      <div
        ...
        <div class="md:7/12 lg:w-1/2">
          ...
          <p class="my-8 text-gray-600 dark:text-gray-300">
            I have independently and motivatedly learned various programming languages. I have always kept myself
            up-to-date and worked on new projects to deepen my skills and get to know new technologies.
          </p>
